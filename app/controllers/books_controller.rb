class BooksController < ApplicationController
  ...
  def create
    ...
    if book.save
      ...
      render json: book.errors, status: :unproccessable_entity # :unproccessable_entity is for a 422, server understands request, unable to process instructions (parameters were wrong)
    end
  end
